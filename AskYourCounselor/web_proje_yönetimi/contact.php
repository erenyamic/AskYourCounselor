  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse bg-dark" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <li class="nav-item">
            <form action="https://cryptoymc.com/danismaninasor/contact.php" method="post">
...
<div class="content">
    ...
    <form action="https://cryptoymc.com/danismaninasor/contact.php" method="post" class="bg-dark">
        <p style="text-decoration:underline;">NOT: Sizinle iletişime geçebilmemiz için lütfen geçerli bir Email adresi kullanınız.</p>
    <div class="mb-3">
    ...
    if(isset($_POST["contactbtn"])){
        ...
        $db=new mysqli("localhost","u990586664_danisman","Eren_6161","u990586664_danisman");
            ...
            die('Error'.('.$db->connect_errno.').$db->connect_error);
                ...
                $sorgu3=$db->query("SET NAMES UTF8");
                $sorgu=$db->query("select * from uyeler where email='$comail'");
                if($sorgu->num_rows>0){
                    $sorgu2=$db->query("insert into message(email,mesaj) values('$comail','$message')");
                    echo "<script>alert('Mesajınız kaydedildi. Geri dönüş sağlanacaktır');</script>";
                }else{
                    echo "<script>alert('Mesaj göndermek için önce üye olmalısınız');</script>";
                }
