            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Öğrenci Ekle-Sil</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Formda boş alan bırakılamaz. Silerken görsel seçmenize gerek yoktur. Email doğru girilince silinir.</li>
                        </ol>
                        <div class="container">
    <form action="https://cryptoymc.com/danismaninasor/admin/addStudent.php" method="post" enctype="multipart/form-data">
    <div class="row">
      <h4>Öğrenci Bilgileri</h4>
      <div class="input-group input-group-icon">
        <input type="email" name="dname" placeholder="Email" required/>
        <div class="input-icon"><i class="fa fa-envelope"></i></div>
      </div>
      <div class="input-group input-group-icon">
        <input type="text" name="dbolum" placeholder="Kullanıcı Adı" required/>
        <div class="input-icon"><i class="fa fa-user"></i></div>
      </div>
      <div class="input-group input-group-icon">
        <input type="text" name="dId" placeholder="Bio" required/>
  ...
  <input type="submit" name="del" class="btn btn-primary" value="Sil"/>
        ...
        if(isset($_POST["add"])){
            ...
            if(move_uploaded_file($dosya,$yol)){
                $sorgu=$db->query("insert into uyeler(email,password,resim,bio,username) values('$dname','$dpass','$dn','$dId','$dbolum')");
        ...
        if(isset($_POST["del"])){
            ...
            $dId=$_POST["dId"];
            $dpass=$_POST["dpass"];
            $sorgu2=$db->query("select * from uyeler where email='$dname'");
            if($sorgu2->num_rows>0){
                $sorgu4=$db->query("delete from uyeler where email='$dname'");
